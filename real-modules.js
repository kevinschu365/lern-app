...
const content = [
  {
    ...
    questions: [
      ...
      multi("Welche Kennzahlen koennen in einer Online-Marketing-Strategie relevant sein?", ["Conversion Rate", "Traffic", "Customer Lifetime Value", "Bueroflaeche"], [0, 1, 2], "KPIs haengen vom Ziel ab, mehrere davon sind oft gleichzeitig wichtig."),
      ...
      multi("Welche Faktoren helfen bei einer strategischen Priorisierung von Massnahmen?", ["Ziele", "Ressourcen", "Zielgruppe", "Beliebigkeit"], [0, 1, 2], "Sinnvolle Priorisierung beruecksichtigt Wirkung, Aufwand und Relevanz."),
  ...
  },
  {
    ...
    questions: [
      ...
      multi("Welche Faktoren gehoeren zur User Experience?", ["Verstaendlichkeit", "Navigation", "Ladezeit", "Zufaellige Effekte ohne Nutzen"], [0, 1, 2], "UX umfasst das gesamte Erleben rund um die Website."),
  ...
  },
  {
    ...
    questions: [
      ...
      multi("Welche Formate koennen Teil einer Content-Strategie sein?", ["Blogartikel", "Newsletter", "Videos", "Interne Reisekostenabrechnung"], [0, 1, 2], "Content Marketing arbeitet ueber mehrere Formate und Kanaele hinweg."),
  ...
  },
  {
    ...
    questions: [
      ...
      multi("Welche Ziele kann Social Media Marketing verfolgen?", ["Reichweite", "Community-Aufbau", "Kundenservice", "Ausschliesslich Lagerverwaltung"], [0, 1, 2], "Social Media kann mehrere Unternehmensziele gleichzeitig unterstuetzen."),
      ...
      multi("Welche Kennzahlen koennen fuer Social Media relevant sein?", ["Engagement Rate", "Reichweite", "Klicks", "Wandfarbe im Buero"], [0, 1, 2], "Abhaengig vom Ziel sind verschiedene KPIs sinnvoll."),
  ...
  },
  {
    ...
    questions: [
      ...
      multi("Welche Faktoren koennen Onpage-SEO beeinflussen?", ["Title und Meta Description", "Ueberschriftenstruktur", "Interne Verlinkung", "Kaffeebohnenauswahl"], [0, 1, 2], "Gute Onpage-Optimierung verbindet Technik, Inhalt und Nutzerlogik."),
      ...
      multi("Welche Kennzahlen koennen zur SEO-Bewertung sinnvoll sein?", ["Organischer Traffic", "Sichtbarkeit", "Rankings", "Parkplatzanzahl"], [0, 1, 2], "Nicht nur Traffic, sondern auch Zielerreichung ist wichtig."),
